			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
					...
					<?php 
 							$query = mysqli_query($con, "SELECT * FROM user WHERE usertype = 'admin'");
 							while($row = mysqli_fetch_array($query)){
 					?>
				    <p class="card-text"><i class="fa fa-user">&nbsp;&nbsp;</i><?php echo $row['username']; ?></p>
				    <p class="card-text"><i class="fa fa-user">&nbsp;&nbsp;</i><?php echo $row['usertype']; ?></p>
				    <p class="card-text">Registration Date : &nbsp; <?php echo $row['register_date']; ?></p>
