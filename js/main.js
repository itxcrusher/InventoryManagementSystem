$(document).ready(function(){
	var DOMAIN = "http://localhost/php/inventory-management-system-master";
	$("#register_form").on("submit",function(){
		...
		if(name.val() == "" || name.val().length < 6){
			...
			$("#u_error").html("<span class='text-success'>Correct!</span>");
			status = true;
		}
		if(!e_patt.test(email.val())){
			...
			$("#e_error").html("<span class='text-success'>Correct!</span>");
			status = true;
		}
		if(pass1.val() == "" || pass1.val().length < 5){
			pass1.addClass("border-danger");
			$("#p1_error").html("<span class='text-danger'>Please Enter more than 5 digits password</span>");
			status = false;
		}else{
			pass1.removeClass("border-danger");
			$("#p1_error").html("<span class='text-success'>Correct!</span>");
			status = true;
		}
		if(pass2.val() == "" || pass2.val().length < 5){
			...
			$("#p2_error").html("<span class='text-success'>Matched!</span>");
			status = true;
		}
		if(type.val() == ""){
			...
			$("#t_error").html("<span class='text-success'>Correct!</span>");
			status = true;
		}
